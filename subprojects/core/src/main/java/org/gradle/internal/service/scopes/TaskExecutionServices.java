...
import org.gradle.api.internal.tasks.timeout.DefaultTaskTimeoutHandler;
import org.gradle.api.internal.tasks.timeout.TaskTimeoutHandler;
...
public class TaskExecutionServices {
    ...
    TaskExecuter createTaskExecuter(TaskArtifactStateRepository repository,
                                    ...
                                    TaskTimeoutHandler taskTimeoutHandler
    ) {
        ...
        executer = new TimeoutTaskExecuter(executer, taskTimeoutHandler);
    ...
    TaskTimeoutHandler createTaskTimeoutHandler(ExecutorFactory executorFactory) {
        return new DefaultTaskTimeoutHandler(executorFactory.createScheduled("task timeouts", 1));
    }
